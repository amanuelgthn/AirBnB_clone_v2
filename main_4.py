...
if "name" not in result or city_name not in result:
    print("FAIL: missing new information Name: \"{}\"".format(result))
if "state_id" not in result:
    print("FAIL: missing new information State_id: \"{}\"".format(result))
if state_id not in result:
    print(state_id)
    print("FAIL: missing new information State_id_num: \"{}\"".format(result))
print("OK", end="")
